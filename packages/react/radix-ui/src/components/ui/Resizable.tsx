  ...
  return (
    <ResizablePrimitive.PanelResizeHandle
      ...
      className={cn(
        ...
        "focus-visible:outline-1 focus-visible:outline-offset-1 focus-visible:outline-gray-400",
        className
      )}
      {...props}
    >
      {withHandle && (
        <div className="z-10 flex h-4 w-3 items-center justify-center rounded-xs border border-none bg-gray-200">
